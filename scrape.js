...
function gotHTML(err, resp, html, auth) {
  ...
  var startDate = '2016-10-09'; // Sunday of the first week that we should put talks onto
  var a = moment(startDate, 'YYYY-MM-DD');
  var b = moment('2017-04-01', 'YYYY-MM-DD'); // date of next Conference
...
function saveTalk(talk, startDatetime, endDatetime, auth) {
  ...
  calendar.events.insert({
      ...
      resource: {
          ...
          summary: talk,
          description: "#ldsconf autogenerated event - October 2016"
      }
...
function scrape(auth) {
  request('https://www.lds.org/general-conference/2016/10?lang=eng', function(err, response, body) {
